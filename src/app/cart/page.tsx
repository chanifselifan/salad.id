      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow-lg h-fit">
            ...
            <button className="w-full mt-6 bg-lime-green text-white font-bold py-4 px-8 rounded-full shadow-lg text-lg hover:bg-lime-600 transition-colors duration-300">
              Checkout
            </button>
          </div>
        </div>
